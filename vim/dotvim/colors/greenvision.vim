...
hi Constant		guifg=#1fc700 guibg=#001c00 gui=bold ctermfg=041 ctermbg=000 cterm=none
...
hi Special		guifg=#00d700 guibg=#001200 gui=bold ctermfg=002 ctermbg=000 cterm=none
hi SpecialKey		guifg=#008000 guibg=#002300 gui=bold ctermfg=034 ctermbg=000 cterm=bold
hi Statement		guifg=#2fc626 guibg=#000000 gui=bold ctermfg=010 ctermbg=000 cterm=none
...
hi Type			guifg=#1fb631 guibg=#000000 gui=bold ctermfg=046 ctermbg=000 cterm=none
