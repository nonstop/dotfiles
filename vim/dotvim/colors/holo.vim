" Holo - Full Colour and 256 Colour
" http://eldamar.se
"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
  ...
  highlight LineNr term=bold cterm=NONE ctermfg=DarkGrey ctermbg=NONE gui=NONE guifg=DarkGrey guibg=NONE
	...
	call <SID>X("MatchParen", s:background, s:selection, "italic")
	call <SID>X("Folded", s:comment, s:background, "")
	call <SID>X("FoldColumn", s:background, s:foreground, "")
    call <SID>X("SpellBad", s:red, s:background, "undercurl")
    call <SID>X("SpellCap", "", "", "none")
    call <SID>X("SpellRare", "", "", "none")
    call <SID>X("SpellLocal", "", "", "none")
	if version >= 700
		call <SID>X("CursorLine", "", s:line, "none")
		call <SID>X("CursorColumn", "", s:line, "none")
		call <SID>X("PMenu", s:background, s:selection, "none")
		call <SID>X("PMenuSel", s:background, s:selection, "")
	end
	if version >= 703
